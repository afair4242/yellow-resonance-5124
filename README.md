...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-resonance-5124
```

A live public deployment of this template is available at [https://yellow-resonance-5124.templates.workers.dev](https://yellow-resonance-5124.templates.workers.dev)
